...
from deutschland.rigoletto import rest
from deutschland.rigoletto.configuration import Configuration
from deutschland.rigoletto.exceptions import ApiException, ApiTypeError, ApiValueError
from deutschland.rigoletto.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.export_tabelle_export_tabelle_get  # this is an instance of the class Endpoint
        api_instance.export_tabelle_export_tabelle_get()  # this invokes api_instance.export_tabelle_export_tabelle_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.export_tabelle_export_tabelle_get.callable or self.callable in this class
